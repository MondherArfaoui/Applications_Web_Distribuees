...
const LogupPatient = () => {
    ...
    const [numSecuriteSociale, setNumSecuriteSociale] = useState('');
    ...
    const onSubmitHandle = async (e) => {
      ...
      try {
        ...
        formData.append("numSecuriteSociale", numSecuriteSociale);
    ...
    <nav className="navbar navbar-expand-xl">
      <div className="container-fluid px-3 px-xl-5">
        ...
        <div className="navbar-nav ms-2">
          <button routerlink="/" className="btn btn-sm btn-dark-soft mb-0"><i className="bi bi-power me-2" />Se connecter</button>
        </div>
      </div>
    </nav>
    {/* Nav END */}
            ...
            <div className="row my-5">
              <div className="col-sm-10 col-xl-8 m-auto">
                ...
                <form onSubmit={onSubmitHandle}>
                  ...
                  <div className="mb-4">
                    <label htmlFor="exampleInputSpes" className="form-label">Date de naissance *</label>
                    <div className="input-group input-group-lg">
                      <span className="input-group-text bg-light rounded-start border-0 text-secondary px-3"><i className="fas fa-user-graduate" /></span>
                      <input type="date" value={dateNaissance}
                    onChange={(e) => setDateNaissance(e.target.value)} className="form-control border-0 bg-light rounded-end ps-1" placeholder="Date de naissance" id="exampleInputSpes" />
                    </div>
                  </div>
                  <div className="mb-4">
                    <label htmlFor="exampleInputMat" className="form-label">Sexe *</label>
                    <div className="input-group input-group-lg">
                      <span className="input-group-text bg-light rounded-start border-0 text-secondary px-3"><i className="fas fa-user-graduate" /></span>
                      <input type="text" value={sexe}
                    onChange={(e) => setSexe(e.target.value)} className="form-control border-0 bg-light rounded-end ps-1" placeholder="Homme/Femme" id="exampleInputMat" />
                    </div>
                  </div>
                  <div className="mb-4">
                    <label htmlFor="exampleInputSpess" className="form-label">Numéro de téléphone *</label>
                    <div className="input-group input-group-lg">
                      <span className="input-group-text bg-light rounded-start border-0 text-secondary px-3"><i className="fas fa-user-graduate" /></span>
                      <input type="text" value={telephone}
                    onChange={(e) => setTelephone(e.target.value)} className="form-control border-0 bg-light rounded-end ps-1" placeholder="Numéro de téléphone" id="exampleInputSpess" />
                    </div>
                  </div>
                  <div className="mb-4">
                    <label htmlFor="exampleInputMatt" className="form-label">Numéro de sécurité sociale *</label>
                    <div className="input-group input-group-lg">
                      <span className="input-group-text bg-light rounded-start border-0 text-secondary px-3"><i className="fas fa-user-graduate" /></span>
                      <input type="text" value={numSecuriteSociale}
                    onChange={(e) => setNumSecuriteSociale(e.target.value)} className="form-control border-0 bg-light rounded-end ps-1" placeholder="Numéro de sécurité sociale" id="exampleInputMatt" />
                    </div>
                  </div>
                  {/* Image */}
                  <div className="mb-4">
