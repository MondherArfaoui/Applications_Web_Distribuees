...
const MedecinHome = () => {
    ...
    useEffect(() => {
        ...
        const fetchProfileData = async () => {
          try {
            const response = await axios.get(`http://localhost:3000/medecin/getById/${userId}`);
            ...
            <div className="card bg-transparent card-body p-0">
              <div className="row d-flex justify-content-between">
                ...
                <div className="col d-md-flex justify-content-between align-items-center mt-4">
                  <div>
                    <h1 className="my-1 fs-4">{user.nom} {user.prenom} <i className="bi bi-patch-check-fill text-info small" /></h1>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="offcanvas-body p-3 p-xl-0">
                <div className="bg-dark border rounded-3 pb-0 p-3 w-100">
                  ...
                  <div className="list-group list-group-dark list-group-borderless">
                    ...
                    <Link to="cabinetMed" className="list-group-item">Ma cabinet</Link>
                    <Link to="listAllCabinet" className="list-group-item">Liste de tous les cabinets</Link>
                    <Link to="listAllServiceM" className="list-group-item">Mes Services Médicales</Link>
